//##############################################################################
// I know some parts are messy, don't worry my more professional projects
// don't look like this lol. Let me know if you make any cool pics with DoodleBox!
//##############################################################################
...
function RGBToHex(rgb) {
  ...
  // Turn "rgb(r,g,b)" into [r,g,b] (this would have been easier in python!)
...
function randomColor() {
  ...
  // this returns fewer colors but they are all nice and bright (so users aren't seeing boring colors!)
...
function fadeGrid(item) {
  // if the cell hasnt been colored, set it to the background color (un-marked cells are transperent)
...
/* PLEASE IGNORE THIS COMMENTED OUT SECTION - I WAS TRYING SOMTHING DUMB */
...
function listen() {
  ...
  // listen for clicks on all grid items when fill is true (color fill)
  for (let i = 0; i < gridItems.length; i++) {
